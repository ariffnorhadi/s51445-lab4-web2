<%-- 
    Document   : dashboard
    Created on : Mar 30, 2020, 6:34:54 PM
    Author     : Ariff Norhadi <Cucumorsed.Al-Johori at https://t.me/ariffnorhadi>
--%>

<%@page import="lab4.Exercise.VehicleDAO"%>
<%@page import="lab4.Exercise.Vehicle"%>
                ...
                <form action="process-vehicle.jsp">
                    ...
                    <%
                        ...
                        while (rs.next()) {
                            ...
                            out.print("<a onclick=\"return confirm('Are u sure about this?')\" class='delete'  href=delete-vehicle.jsp?id=" + rs.getInt(1) + ">Delete</a> ");
                            out.print("</td>");
                            out.print("</tr>");
                            i++;
                        }
